            ...
            <div className="blogContainer">
                ...
                <div className="card shadow">
                    ...
                    <div className="text-center">
                        ...
                        <button type="button" class="btn mb-4 readMoreBlogButton" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            Read More
                        </button>
                    </div>
                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn readMoreBlogButton" data-bs-dismiss="modal">Close</button>
                        </div>
                    </div>
                </div>
            </div>
